...
describe Board do
  ...
  context '#full?' do
    it 'returns true if the board is full of pieces' do
      ...
      game.put_piece_in_column(3, game.player2.piece)
      game.put_piece_in_column(3, game.player1.piece)
      game.put_piece_in_column(3, game.player2.piece)
      game.put_piece_in_column(3, game.player1.piece)
      game.put_piece_in_column(3, game.player2.piece)
      game.put_piece_in_column(4, game.player2.piece)
      game.put_piece_in_column(4, game.player1.piece)
      game.put_piece_in_column(4, game.player2.piece)
      game.put_piece_in_column(4, game.player1.piece)
      game.put_piece_in_column(4, game.player2.piece)
      game.put_piece_in_column(4, game.player1.piece)
      game.put_piece_in_column(5, game.player1.piece)
      game.put_piece_in_column(5, game.player2.piece)
      game.put_piece_in_column(5, game.player1.piece)
      game.put_piece_in_column(5, game.player2.piece)
      game.put_piece_in_column(5, game.player1.piece)
      game.put_piece_in_column(5, game.player2.piece)
      game.put_piece_in_column(6, game.player2.piece)
      game.put_piece_in_column(6, game.player1.piece)
      game.put_piece_in_column(6, game.player2.piece)
      game.put_piece_in_column(6, game.player1.piece)
      game.put_piece_in_column(6, game.player2.piece)
      game.put_piece_in_column(6, game.player1.piece)
      game.put_piece_in_column(7, game.player2.piece)
      game.put_piece_in_column(7, game.player1.piece)
      game.put_piece_in_column(7, game.player2.piece)
      game.put_piece_in_column(7, game.player1.piece)
      game.put_piece_in_column(7, game.player2.piece)
      game.put_piece_in_column(7, game.player1.piece)
